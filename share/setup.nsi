...
!define URL http://www.onecoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/onecoin.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\onecoin-qt.exe
...
OutFile onecoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/onecoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/onecoind.exe
    ...
    #Delete /REBOOTOK $INSTDIR\onecoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\onecoin-qt.exe
